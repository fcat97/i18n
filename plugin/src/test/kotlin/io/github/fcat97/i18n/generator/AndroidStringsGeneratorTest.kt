...
class AndroidStringsGeneratorTest {
    ...
    fun generateEscapesXmlSpecialCharacters() {
        val tempDir = createTempDir()
        val entries = listOf(
            LocalizationEntry(key = "ampersand", platform = "android", defaultValue = "A & B", translations = emptyMap()),
            LocalizationEntry(key = "less_than", platform = "android", defaultValue = "A < B", translations = emptyMap()),
            LocalizationEntry(key = "greater_than", platform = "android", defaultValue = "A > B", translations = emptyMap()),
            LocalizationEntry(key = "quote", platform = "android", defaultValue = "A \"B\"", translations = emptyMap()),
            LocalizationEntry(key = "apostrophe", platform = "android", defaultValue = "A 'B'", translations = emptyMap())
        )
        val data = LocalizationData(
            defaultLocale = "default",
            additionalLocales = emptyList(),
